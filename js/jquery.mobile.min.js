/*! jQuery Mobile vGit Build: SHA1: f2a50a111f5bde8a2bad769f280edd9993ae863f <> Date: Mon Aug 13 22:03:20 2012 +0300 jquerymobile.com | jquery.org/license !*/
(function (a, b, c) {
    ...
    (function (a, b, d) {
        ...
        function l(a) {
            var b = a.charAt(0).toUpperCase() + a.substr(1), c = (a + " " + g.join(b + " ") + b).split(" ");
            for (var e in c)if (f[c[e]] !== d)return!0
        }
        ...
        function n() {
            var b = "transform-3d";
            return m("perspective", "10px", "moz") || a.mobile.media("(-" + g.join("-" + b + "),(-") + "-" + b + "),(" + b + ")")
        }

        function o() {
            var b = location.protocol + "//" + location.host + location.pathname + "ui-dir/", c = a("head base"), d = null, f = "", g, h;
            return c.length ? f = c.attr("href") : c = d = a("<base>", {href:b}).appendTo("head"), g = a("<a href='testurl' />").prependTo(e), h = g[0].href, c[0].href = f || location.pathname, d && d.remove(), h.indexOf(b) === 0
        }
        ...
        var e = a("<body>").prependTo("html"), f = e[0].style, g = ["Webkit", "Moz", "O"], h = "palmGetResource"in b, i = b.opera, j = b.operamini && {}.toString.call(b.operamini) === "[object OperaMini]", k = b.blackberry;
        a.extend(a.mobile, {browser:{}}), a.mobile.browser.ie = function () {
            var a = 3, b = c.createElement("div"), d = b.all || [];
            do b.innerHTML = "<!--[if gt IE " + ++a + "]><br><![endif]-->"; while (d[0]);
            return a > 4 ? a : !a
        }(), a.extend(a.support, {cssTransitions:"WebKitTransitionEvent"in b || m("transition", "height 100ms linear") && !i, pushState:"pushState"in history && "replaceState"in history, mediaquery:a.mobile.media("only all"), cssPseudoElement:!!l("content"), touchOverflow:!!l("overflowScrolling"), cssTransform3d:n(), boxShadow:!!l("boxShadow") && !k, scrollTop:("pageXOffset"in b || "scrollTop"in c.documentElement || "scrollTop"in e[0]) && !h && !j, dynamicBaseTag:o(), cssPointerEvents:p()}), e.remove();
        var q = function () {
        ...
        }, a.mobile.ajaxBlacklist = b.blackberry && !b.WebKitPoint || j || q, q && a(function () {
        ...
        var e = a(b), f = a("html"), g = a("head"), h = {urlParseRE:/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/, getLocation:function (b) {
            var c = b ? a.mobile.path.parseUrl(b) : location;
            ...
            return a === d && (a = location.hash), h.stripHash(a).replace(/[^\/]*\.[^\/*]+$/, "")
        ...
        x = function () {
            ...
            f.pageContainer = f.pageContainer || a.mobile.pageContainer, g = f.pageContainer.children(":jqmData(url='" + m + "')"), g.length === 0 && m && !h.isPath(m) && (g = f.pageContainer.children("#" + m).attr("data-" + a.mobile.ns + "url", m).jqmData("url", m));
            ...
            return!a.mobile.allowCrossDomainPages && !h.isSameDomain(p, k) ? e.reject(k, c) : a.ajax({url:l, type:f.type, data:f.data, dataType:"html", success:function (d, j, n) {
            ...
            a(c).delegate("form", "submit", function (b) {
                ...
                if (f.is(":jqmData(rel='back')"))return b.history.back(), !1;
        ...
        a.widget("mobile.dialog", a.mobile.widget, {options:{closeBtnText:"Close", overlayTheme:"a", initSelector:":jqmData(role='dialog')"}, _create:function () {
            ...
            var c;
            this._isCloseable && (this._isCloseable = !1, a.mobile.hashListeningEnabled ? b.history.back() : (c = a.mobile.urlHistory.getPrev().url, a.mobile.path.isPath(c) || (c = a.mobile.path.makeUrlAbsolute("#" + c)), a.mobile.changePage(c, {changeHash:!1, fromHashChange:!0})))
        ...
        a.fn.grid = function (b) {
            return this.each(function () {
                ...
                h = f[g], c.addClass("ui-grid-" + g), e.filter(":nth-child(" + h + "n+1)").addClass("ui-block-a"), h > 1 && e.filter(":nth-child(" + h + "n+2)").addClass("ui-block-b"), h > 2 && e.filter(":nth-child(3n+3)").addClass("ui-block-c"), h > 3 && e.filter(":nth-child(4n+4)").addClass("ui-block-d"), h > 4 && e.filter(":nth-child(5n+5)").addClass("ui-block-e")
            })
        }
    }(a), function (a, b) {
        a(c).bind("pagecreate create", function (b) {
        ...
        a.widget("mobile.navbar", a.mobile.widget, {options:{iconpos:"top", grid:null, initSelector:":jqmData(role='navbar')"}, _create:function () {
            ...
            c.addClass("ui-navbar ui-mini").attr("role", "navigation").find("ul").jqmEnhanceable().grid({grid:this.options.grid}), d.buttonMarkup({corners:!1, shadow:!1, inline:!0, iconpos:e}), c.delegate("li", "vclick", function (b) {
                var c = a(b.target).closest("a");
                if (!c.length)return c = a(this).children("a").first(), setTimeout(function () {
                    c.trigger("click")
                }), !1;
                d.removeClass(a.mobile.activeBtnClass), c.hasClass("ui-disabled") || c.addClass(a.mobile.activeBtnClass)
        ...
        a.mobile.listview.prototype.options.autodividers = !1, a.mobile.listview.prototype.options.autodividersSelector = function (a) {
            ...
            if (!d.options.autodividers)return;
            var e = function () {
        ...
        a.widget("mobile.popup", a.mobile.widget, {options:{theme:null, overlayTheme:null, shadow:!0, corners:!0, transition:"none", positionTo:"origin", tolerance:null, initSelector:":jqmData(role='popup')"}, _eatEventAndClose:function (a) {
            a.preventDefault(), a.stopImmediatePropagation(), this.close()
        }, _handleWindowKeyUp:function (b) {
            this._isOpen && b.keyCode === a.mobile.keyCode.ESCAPE && this._eatEventAndClose(b)
            ...
            this._maybeRefreshTimeout() || (this._trigger("beforeposition"), this._ui.container.removeClass("ui-selectmenu-hidden").offset(this._placementCoords(this._desiredCoords(d, d, "window"))), this._resizeData = null, this._orientationchangeInProgress = !1)
            ...
            var c = {screen:a("<div class='ui-screen-hidden ui-popup-screen fade'></div>"), placeholder:a("<div style='display: none;'><!-- placeholder --></div>"), container:a("<div class='ui-popup-container ui-selectmenu-hidden'></div>")}, e = this.element.closest(".ui-page"), f = this.element.attr("id"), g = this;
            e.length === 0 && (e = a("body")), e.append(c.screen), c.container.insertAfter(c.screen), c.placeholder.insertAfter(this.element), f && (c.screen.attr("id", f + "-screen"), c.container.attr("id", f + "-popup"), c.placeholder.html("<!-- placeholder for " + f + " -->")), c.container.append(this.element), this.element.addClass("ui-popup"), a.extend(this, {_page:e, _ui:c, _fallbackTransition:"", _currentTransition:!1, _prereqs:null, _isOpen:!1, _tolerance:null, _resizeData:null, _orientationchangeInProgress:!1, _globalHandlers:[
            ...
            this._applyTheme(this._ui.screen, b, "overlay"), a.mobile.browser.ie && this._ui.screen.toggleClass("ui-popup-screen-background-hack", this._ui.screen.css("background-color") === "transparent" && this._ui.screen.css("background-image") === "none" && this._ui.screen.css("background") === d), this._isOpen && this._ui.screen.addClass("in")
            ...
            if (b) {
                ...
                switch (d.length) {
                    case 1:
                        ...
                        break;
                    case 2:
                        isNaN(d[1]) || (c.t = c.b = d[1]), isNaN(d[0]) || (c.l = c.r = d[0]);
                        break;
                    case 4:
                        isNaN(d[1]) || (c.t = d[1]), isNaN(d[2]) || (c.r = d[2]), isNaN(d[3]) || (c.b = d[3]), isNaN(d[0]) || (c.l = d[0]);
                        break;
                    default:
                }
            }
            ...
            var e = "_set" + b.charAt(0).toUpperCase() + b.slice(1);
            this[e] !== d && this[e](c), b !== "initSelector" && (a.mobile.widget.prototype._setOption.apply(this, arguments), this.element.attr("data-" + (a.mobile.ns || "") + b.replace(/([A-Z])/, "-$1").toLowerCase(), c))
            ...
            this._prereqs && a.each(this._prereqs, function (a, b) {
                b.resolve()
            })
            ...
            this.options.overlayTheme && b.additionalCondition ? this._ui.screen.removeClass(b.classToRemove).addClass(b.screenClassToAdd).animationComplete(a.proxy(b.prereqs.screen, "resolve")) : b.prereqs.screen.resolve(), b.transition && b.transition !== "none" ? (b.applyTransition && this._applyTransition(b.transition), this._ui.container.addClass(b.containerClassToAdd).removeClass(b.classToRemove).animationComplete(a.proxy(b.prereqs.container, "resolve"))) : b.prereqs.container.resolve()
            ...
            this._ui.container.addClass("ui-popup-active"), this._isOpen = !0, this._ui.container.attr("tabindex", "0").focus(), this._trigger("afteropen")
        }, _open:function (b) {
            var c, d;
            b = b || {}, d = b.transition, this._trigger("beforeposition"), c = this._placementCoords(this._desiredCoords(b.x, b.y, b.positionTo || this.options.positionTo || "origin")), this._createPrereqs(a.noop, a.noop, a.proxy(this, "_openPrereqsComplete")), d ? (this._currentTransition = d, this._applyTransition(d)) : d = this.options.transition, this.options.theme || this._setTheme(this._page.jqmData("theme") || a.mobile.getInheritedTheme(this._page, "c")), this._ui.screen.removeClass("ui-screen-hidden"), this._ui.container.removeClass("ui-selectmenu-hidden").offset(c), this._animate({additionalCondition:!0, transition:d, classToRemove:"", screenClassToAdd:"in", containerClassToAdd:"in", applyTransition:!1, prereqs:this._prereqs})
            ...
            this._ui.container.removeAttr("tabindex"), this._trigger("afterclose")
        }, _close:function () {
            this._ui.container.removeClass("ui-popup-active"), this._isOpen = !1, this._createPrereqs(a.proxy(this, "_closePrereqScreen"), a.proxy(this, "_closePrereqContainer"), a.proxy(this, "_closePrereqsDone")), this._animate({additionalCondition:this._ui.screen.hasClass("in"), transition:this._currentTransition || this.options.transition, classToRemove:"in", screenClassToAdd:"out", containerClassToAdd:"reverse out", applyTransition:!0, prereqs:this._prereqs})
        }, _destroy:function () {
            this._setTheme("none"), this.element.insertAfter(this._ui.placeholder).removeClass("ui-popup ui-overlay-shadow ui-corner-all"), this._ui.screen.remove(), this._ui.container.remove(), this._ui.placeholder.remove(), a.each(this._globalHandlers, function (b, c) {
                a.each(c.handler, function (a, b) {
                    c.src.unbind(a, b)
                })
            })
        }, open:function (b) {
            a.mobile.popup.popupManager.push(this, arguments)
        }, close:function () {
            a.mobile.popup.popupManager.pop(this)
        }}), a.mobile.popup.popupManager = {_currentlyOpenPopup:null, _popupIsOpening:!1, _popupIsClosing:!1, _abort:!1, _handlePageBeforeChange:function (b, c) {
            var d, e;
            typeof c.toPage == "string" ? d = c.toPage : d = c.toPage.jqmData("url"), d = a.mobile.path.parseUrl(d), e = d.pathname + d.search + d.hash, this._myUrl !== e && this._navUnhook(!0)
        }, _navHook:function (c) {
            function f() {
                a(b).one("navigate.popup", function () {
                    d._onHashChange()
                }), c()
            }

            var d = this, e;
            d._myUrl = a.mobile.activePage.jqmData("url"), a.mobile.pageContainer.one("pagebeforechange.popup", a.proxy(this, "_handlePageBeforeChange"));
            if (a.mobile.hashListeningEnabled) {
                var g = a.mobile.urlHistory.getActive(), h, i = a.mobile.activePage.is(".ui-dialog"), j = g.url.indexOf(a.mobile.dialogHashKey) > -1 && !i;
                a.mobile.urlHistory.activeIndex === 0 ? h = a.mobile.defaultDialogTransition : h = g.transition, j ? f() : (a(b).one("navigate.popupBinder", function () {
                    f()
                }), e = g.url + a.mobile.dialogHashKey, a.mobile.urlHistory.activeIndex === 0 && e === a.mobile.urlHistory.initialDst && (e += a.mobile.dialogHashKey), a.mobile.urlHistory.ignoreNextHashChange = i, a.mobile.urlHistory.addNew(e, h, g.title, g.pageUrl, g.role), a.mobile.path.set(e))
            } else c()
        }, _navUnhook:function (c) {
            c && a(b).unbind("navigate.popupBinder navigate.popup"), a.mobile.hashListeningEnabled && !c ? b.history.back() : this._onHashChange(c), a.mobile.activePage.unbind("pagebeforechange.popup")
        }, push:function (a, b) {
            var c = this;
            c._currentlyOpenPopup || (c._currentlyOpenPopup = a, c._navHook(function () {
                c._popupIsOpening = !0, c._currentlyOpenPopup.element.one("popupafteropen", function () {
                    c._popupIsOpening = !1
                }), c._currentlyOpenPopup._open.apply(c._currentlyOpenPopup, b), !c._popupIsOpening && c._abort && c._currentlyOpenPopup._immediate()
            }))
        }, pop:function (b) {
            b === this._currentlyOpenPopup && !this._popupIsClosing && (this._popupIsClosing = !0, this._popupIsOpening ? this._currentlyOpenPopup.element.one("popupafteropen", a.proxy(this, "_navUnhook")) : this._navUnhook())
        }, _handlePopupAfterClose:function () {
            this._popupIsClosing = !1, this._currentlyOpenPopup = null, a(this).trigger("done")
        }, _onHashChange:function (b) {
            this._abort = b, this._currentlyOpenPopup && (b && this._popupIsOpening && this._currentlyOpenPopup._immediate(), this._popupIsClosing = !0, this._currentlyOpenPopup.element.one("popupafterclose", a.proxy(this, "_handlePopupAfterClose")), this._currentlyOpenPopup._close(), b && this._currentlyOpenPopup && this._currentlyOpenPopup._immediate())
        }}, a.mobile.popup.handleLink = function (b) {
            var c = b.closest(":jqmData(role='page')"), d = c.length === 0 ? a("body") : c, e = a(b.attr("href"), d[0]), f;
            e.data("popup") && (f = b.offset(), e.popup("open", {x:f.left + b.outerWidth() / 2, y:f.top + b.outerHeight() / 2, transition:b.jqmData("transition"), positionTo:b.jqmData("position-to")}), b.parents(".ui-popup-container").length === 0 && a(a.mobile.popup.popupManager).one("done", function () {
                b.focus()
            })), setTimeout(function () {
        ...
        var e = function (d) {
            ...
            d.isMultiple && (t = a("<a>", {text:d.options.closeText, href:"#", "class":"ui-btn-left"}).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(p).buttonMarkup()), a.extend(d, {select:d.select, selectID:f, buttonId:k, menuId:l, thisPage:h, menuPage:m, label:g, selectOptions:i, isMultiple:j, theme:d.options.theme, listbox:n, list:o, header:p, headerTitle:q, headerClose:t, menuPageContent:r, menuPageClose:s, placeholder:"", build:function () {
                ...
                var a = this;
                a.menuType === "page" ? b.history.back() : (a.listbox.popup("close"), a.list.appendTo(a.listbox), a._focusButton()), a.isOpen = !1
            }, open:function () {
                function o() {
        ...
        a.widget("mobile.fixedtoolbar", a.mobile.widget, {options:{visibleOnPageShow:!0, disablePageZoom:!0, transition:"slide", fullscreen:!1, tapToggle:!0, tapToggleBlacklist:"a, button, input, select, textarea, .ui-header-fixed, .ui-footer-fixed", hideDuringFocus:"input, textarea, select", updatePagePadding:!0, trackPersistentToolbars:!0, supportBlacklist:function () {
            ...
            e.closest(".ui-page").bind("pagebeforeshow",function () {
                ...
                if (d.trackPersistentToolbars) {
                    var g = a(".ui-footer-fixed:jqmData(id)", this), h = a(".ui-header-fixed:jqmData(id)", this), i = g.length && f.nextPage && a(".ui-footer-fixed:jqmData(id='" + g.jqmData("id") + "')", f.nextPage), j = h.length && f.nextPage && a(".ui-header-fixed:jqmData(id='" + h.jqmData("id") + "')", f.nextPage);
                    i = i || a();
        ...
        a.mobile.ajaxBlacklist && (a.mobile.ajaxEnabled = !1), e.addClass("ui-mobile ui-mobile-rendering"), setTimeout(h, 5e3), a.extend(a.mobile, {initializePage:function () {
            ...
            }), a.mobile.firstPage = b.first(), a.mobile.pageContainer = b.first().parent().addClass("ui-mobile-viewport"), g.trigger("pagecontainercreate"), a.mobile.showPageLoadingMsg(), h(), !a.mobile.hashListeningEnabled || !a.mobile.path.isHashValid(location.hash) || !a(location.hash + ':jqmData(role="page")').length && !a.mobile.path.isPath(location.hash) ? (a.mobile.path.isHashValid(location.hash) && (a.mobile.urlHistory.initialDst = a.mobile.path.parseLocation().hash.replace("#", "")), a.mobile.changePage(a.mobile.firstPage, {transition:"none", reverse:!0, changeHash:!1, fromHashChange:!0})) : g.trigger("hashchange", [!0])
